...
func InitModule(ctx context.Context, logger runtime.Logger, db *sql.DB, nk runtime.NakamaModule, initializer runtime.Initializer) error {
	...
	if err := initializer.RegisterRpc(rpcIdLeaderboard, rpcLeaderboard); err != nil {
		return err
	}

	// Register the leaderboard creation logic
	if err := registerLeaderboard(ctx, nk); err != nil {
