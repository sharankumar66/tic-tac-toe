...
var app = (function () {
    ...
    class InGame extends Phaser.Scene {
        ...
        setPlayerTurn(data) {
            ...
            if (!this.headerText) {
                console.error("headerText is not initialized.");
                return;
            }
        ...
        endGame(data) {
            ...
            // Show the exit and leaderboard buttons after the game ends
            this.showEndGameButtons();
        }

        showEndGameButtons() {
            this.exitButton = this.add
                .rectangle(CONFIG.WIDTH / 2, 600, 270, 70, 0x702c0a)
                .setInteractive({ useHandCursor: true })
                .on("pointerdown", () => this.exitGame());

            this.add
                .text(CONFIG.WIDTH / 2, 600, "Exit Game", {
                    fontFamily: "Arial",
                    fontSize: "36px",
                })
                .setOrigin(0.5);
            ...
            this.leaderboardButton = this.add
                .rectangle(CONFIG.WIDTH / 2, 680, 270, 70, 0xbea111)
                .setInteractive({ useHandCursor: true })
                .on("pointerdown", () => this.showLeaderboard());

            this.add
                .text(CONFIG.WIDTH / 2, 680, "Leaderboard", {
                    fontFamily: "Arial",
                    fontSize: "36px",
                })
                .setOrigin(0.5);
        ...
        exitGame() {
            Nakama$1.socket.leaveMatch(Nakama$1.matchID);
    ...
    //     addRectangle(x, y, index) {
    //         this.add
    //             .rectangle(x, y, 100, 100, 0x0d3f5a)
    //             .setInteractive({ useHandCursor: true })
    //             .on("pointerdown", async () => {
